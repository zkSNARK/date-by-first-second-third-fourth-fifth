...
class GetMondayDateOffset(TestCase):
    ...
    def test_first_mondays_2019(self):
        for i in range(1, 13):
            ...
            date_of_first_mon = get_next_date_offset(day=calendar.MONDAY, date=seed_date, position=Order.FIRST)
    ...
    def test_second_mondays_2019(self):
        for i in range(1, 13):
            seed_date = datetime.date(year=2019, month=i, day=1)
            date_of_second_mon = get_next_date_offset(day=calendar.MONDAY, date=seed_date, position=Order.SECOND)
    ...
    def test_third_mondays_2019(self):
        for i in range(1, 13):
            seed_date = datetime.date(year=2019, month=i, day=1)
            date_of_third_mon = get_next_date_offset(day=calendar.MONDAY, date=seed_date, position=Order.THIRD)
    ...
    def test_fourth_mondays_2019(self):
        for i in range(1, 13):
            seed_date = datetime.date(year=2019, month=i, day=1)
            date_of_fourth_mon = get_next_date_offset(day=calendar.MONDAY, date=seed_date, position=Order.FOURTH)
    ...
    def test_fifth_mondays_2019(self):
        for i in range(1, 13):
            seed_date = datetime.date(year=2019, month=i, day=1)
            d2 = get_next_date_offset(day=calendar.MONDAY, date=seed_date, position=Order.FIFTH)
            if d2:
                d2 = d2.day
    ...
    def test_fifth_mondays_2022(self):
        for i in range(1, 13):
            ...
            d1 = get_next_date_offset(day=calendar.MONDAY, date=seed_date, position=Order.FIFTH)
            if d1:
                d1 = d1.day
            self.assertEqual(d1, d2)
